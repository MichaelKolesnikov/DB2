...
\lstinputlisting[language=yaml, label={lst:docker-compose}, frame=none, numbers=none]{data/database_creating.yml}

\subsection{Создание таблиц}
\lstinputlisting[language=SQL, label={lst:sql-example}, frame=none, numbers=none]{data/tables_creating.sql}
